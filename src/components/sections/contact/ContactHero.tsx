...
const quickActions = [
  { label: "Call our parts team", value: "(888) 528-3657", href: "tel:8885283657", icon: PhoneCall },
  { label: "Email support", value: "admin.tx@partscentral.us", href: "mailto:admin.tx@partscentral.us", icon: Mail },
...
export default function ContactHero() {
  return (
    <SubHero
      ...
      actions={
        <>
          <Button href="tel:8885283657" size="lg" className={primaryCtaClass}>
