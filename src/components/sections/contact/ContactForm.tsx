...
export default function ContactForm() {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setStatus("ready");
    window.location.href = `mailto:admin.tx@partscentral.us?subject=${subject}&body=${body}`;
  }
            ...
            <div className="mt-8 space-y-4">
              ...
              >
                ...
                <span>
                  ...
                  <span className="block text-base font-bold text-primary dark:text-cyan-100">(888) 528-3657</span>
                </span>
              </a>
              <a
