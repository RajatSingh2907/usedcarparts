  ...
  return (
    <section className="relative overflow-hidden py-24">
      ...
      <Container className="relative z-10">
        <Reveal>
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.03] p-10 backdrop-blur-xl md:p-16">

            <div className="mx-auto max-w-3xl text-center">

              <div className="mb-6 inline-flex items-center rounded-full border border-cyan-500/20 bg-cyan-500/10 px-4 py-2 text-sm font-semibold text-cyan-300">
              ...
              <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <Link
                  href="/contact"
                  className="inline-flex h-14 items-center justify-center rounded-xl border border-white/15 bg-white/5 px-8 font-semibold text-white transition hover:bg-white/10"
                >
                  Request Quote
                </Link>
